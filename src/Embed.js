              ...
              <div className="mx-auto max-w-md px-4 max-w-2xl px-6 text-center">
                <div className="">
                  ...
                  <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white mt-5 text-6xl">
                    ...
                    <span className="block text-indigo-400">NextFriday</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-300 mt-5 text-xl">.. the future of social, financial and business development.</p>
                  ...
                  <div className="relative shadow-xl rounded-2xl overflow-hidden">
                    ...
                    <div className="relative px-4 py-16 px-6 py-24">
                      <h1 className="text-center text-4xl font-extrabold tracking-tight text-5xl">
                        <span className="block text-white">consider it</span>
                        <span className="block text-indigo-200">your next promotion</span>
                      </h1>
                      <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 max-w-3xl">Earn weekly derivitives and live your best life!</p>
